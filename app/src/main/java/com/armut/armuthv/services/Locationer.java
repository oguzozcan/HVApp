...
//            Log.d(DEBUG_TAG, "location unavailable. " );
//            if(location != null){
//                Log.d(DEBUG_TAG, "location.getAccuracy() : " + + location.getAccuracy());
//            }
//            //mu.appendLog(DEBUG_TAG, "location unavailable.");
//            return;
//        }
//        Log.d(DEBUG_TAG, "onLocationChanged method invoked by " + location.getProvider() + " - Accuracy: " + location.getAccuracy());
...
//        Log.e(DEBUG_TAG, "LOCATIONER location listener provides that: LAT: " + lat + " - Lon: " + lon);
//
//        // Do something.
...
//        Log.d(DEBUG_TAG, "put in value " + result + " " + extra);
