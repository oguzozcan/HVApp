...
public class LocContentProvider extends ContentProvider {
    ...
    //private static final String AUTHORITY = "com.yyl.myrmex.tracking.database";
    private static final String AUTHORITY = "com.armut.armuthv";
    ...
    private void checkColumns(String[] projection) {
        String[] available = { LocTable.COLUMN_TIME,
                ...
                LocTable.COLUMN_ID, LocTable.COLUMN_EXTRA };
        if (projection != null) {
