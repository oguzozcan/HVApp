...
public class NothingSelectedSpinnerAdapter implements SpinnerAdapter, ListAdapter {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = adapter.getView(position - EXTRA, null, parent);
        if(view == null){
            return convertView;
        }
        return view; // Could re-use
    ...
    private View getNothingSelectedView(ViewGroup parent) {
        ...
        try{
            ...
            //textView.setTypeface(ArmutUtils.loadFont(context.getAssets(), context.getString(R.string.font_pera_regular)));
        }catch(Exception e){
            e.printStackTrace();
        }
        return view;
